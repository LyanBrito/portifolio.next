	...
	return (
		<div className={s.homeContainer}>
			...
			<main id="home" className={s.textWrapper}>
				...
				<p>
					Hi! I'm a developer passionate in UI/UX & Web Development.
					Throughout my journey, I gained experience in several areas.
					Take a look on my works.
				</p>
			</main>
			...
			<section id="projects" className={s.sectionContainer}>
				<SectionLink
					isLink={true}
					title="Projects"
					description="As a student, I tracked my journey in development producting some projects"
					linkLabel="View More"
					linkRef="/ProjectsPage"
					isBlank={false}
				/>
				<div className={s.cardWrapper}>
			...
			<section id="contacts" className={s.sectionContainer}>
				...
				<div className={s.socialWrapepr}>
					...
					<Link className={s.socialLink} href="tel:+5511986581730">
						<WhatsappIcon />
						(11) 9 8658-1730
					</Link>
					<Link className={s.button} href="/ContactsPage">
