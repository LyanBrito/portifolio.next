    ...
    return (
        <div className={s.homeContainer}>
            ...
            <section id="about-me" className={s.sectionContainer}>
                <SectionLink isLink={true} isBlank={false} title="About me"
                             description="Here some special skills that i learned in my trajectory" linkLabel="More"
                             linkRef="/AboutMePage"/>
            ...
            <section id="projects" className={s.sectionContainer}>
                <SectionLink isLink={true} title="Projects"
                             description="As a student, I tracked my journey in development producting some projects"
                             linkLabel="View More" linkRef="/ProjectsPage" isBlank={false}/>
                <div className={s.cardWrapper}>
