    ...
    return (
        <nav className={s.navContainer}>
            <div className={`${s.menuContent} ${menuOpen ? s.opened : ""}`}>
                <Link href={"/"} className={`${s.link} ${page == "home" ? s.selected : ""}`}
                      onClick={handleMenuClose}>Home</Link>
                <Link href={"/AboutMePage"} className={`${s.link} ${page == "about-me" ? s.selected : ""}`}
                      onClick={handleMenuClose}>About Me</Link>
                <Link href={"/ProjectsPage"} className={`${s.link} ${page == "projects" ? s.selected : ""}`}
                      onClick={handleMenuClose}>Projects</Link>
                <Link href={"/ContactsPage"} className={`${s.link} ${page == "contacts" ? s.selected : ""}`}
