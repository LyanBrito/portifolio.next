...
const NodeJsIcon = (props: SVGProps<SVGSVGElement>) => {
    ...
    return (
        ...
        >
            <defs>
                <linearGradient id={`${idPrefix}grad-b`} x1="83.758" y1="37.188" x2="68.328" y2="73.328" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#3F8B3D" />
                    <stop offset=".64" stopColor="#3F873F" />
                    <stop offset=".93" stopColor="#3DA92E" />
                    <stop offset="1" stopColor="#3DAE2B" />
                </linearGradient>
                <linearGradient id={`${idPrefix}grad-d`} x1="72.228" y1="55.428" x2="121.428" y2="29.028" gradientUnits="userSpaceOnUse">
                ...
                <linearGradient id={`${idPrefix}grad-f`} x1="53.678" y1="53.128" x2="97.428" y2="53.128" gradientUnits="userSpaceOnUse">
            ...
            <g>
                <path fillRule="evenodd" clipRule="evenodd" d="M43.674 41.954c0-.834-.46-1.62-1.197-2.038L23.01 28.572c-.322-.185-.69-.278-1.058-.324h-.184c-.368 0-.736.139-1.059.324l-19.512 11.3A2.38 2.38 0 0 0 0 41.953l.046 30.378c0 .416.23.833.598 1.018.368.232.829.232 1.15 0l11.598-6.668a2.36 2.36 0 0 0 1.197-2.037V50.428c0-.833.46-1.62 1.196-2.037l4.924-2.871a2.2 2.2 0 0 1 1.197-.325c.414 0 .828.093 1.15.325l4.925 2.87a2.36 2.36 0 0 1 1.196 2.038v14.217c0 .833.46 1.62 1.197 2.037L41.88 73.35c.368.232.828.232 1.197 0 .368-.185.598-.602.598-1.018zM137.465.139c-.369-.185-.829-.185-1.151 0-.368.231-.598.602-.598 1.019v30.1a.88.88 0 0 1-.415.74.88.88 0 0 1-.828 0l-4.878-2.825a2.36 2.36 0 0 0-2.347 0L107.735 40.52a2.36 2.36 0 0 0-1.196 2.037V65.2c0 .834.46 1.621 1.196 2.038l19.513 11.345a2.36 2.36 0 0 0 2.347 0l19.513-11.345a2.36 2.36 0 0 0 1.196-2.038V8.752c0-.88-.46-1.667-1.196-2.084zm-1.795 57.606c0 .232-.092.417-.276.51l-6.674 3.89a.68.68 0 0 1-.598 0l-6.673-3.89c-.184-.093-.276-.325-.276-.51v-7.78c0-.231.092-.416.276-.509l6.673-3.89a.68.68 0 0 1 .598 0l6.674 3.89c.184.093.276.324.276.51zm66.728-7.965c.737-.417 1.151-1.204 1.151-2.038v-5.51c0-.834-.46-1.62-1.151-2.037l-19.375-11.3a2.36 2.36 0 0 0-2.347 0l-19.512 11.346a2.36 2.36 0 0 0-1.197 2.037v22.645c0 .833.46 1.62 1.197 2.037l19.374 11.114c.737.416 1.611.416 2.301 0l11.736-6.576c.368-.185.598-.602.598-1.019s-.23-.833-.598-1.018L174.97 58.115c-.368-.231-.598-.602-.598-1.018v-7.085c0-.417.23-.834.598-1.02l6.121-3.518a1.12 1.12 0 0 1 1.196 0l6.121 3.519c.368.231.598.602.598 1.019v5.557c0 .416.23.833.599 1.018.368.232.828.232 1.196 0z" fill="#333" />
                <path fillRule="evenodd" clipRule="evenodd" d="M181.551 48.716a.42.42 0 0 1 .461 0l3.727 2.176c.138.092.23.231.23.417v4.352a.5.5 0 0 1-.23.417l-3.727 2.177a.42.42 0 0 1-.461 0l-3.727-2.177a.49.49 0 0 1-.23-.417V51.31c0-.185.092-.325.23-.417z" fill="#5FA04E" />

                {/* Hexágono Principal com Gradientes */}
                <path d="M76.301 29.045a2.36 2.36 0 0 0-2.348 0L54.579 40.297c-.737.417-1.151 1.204-1.151 2.038v22.551c0 .834.46 1.621 1.15 2.038l19.375 11.253a2.36 2.36 0 0 0 2.348 0l19.374-11.253c.737-.417 1.15-1.204 1.15-2.038V42.335c0-.834-.46-1.62-1.15-2.038z" fill={`url(#${idPrefix}grad-b)`} />
                <path d="m75.127 27.581 21.506 12.995-21.505 39.125-21.547-13.018z" fill={`url(#${idPrefix}grad-d)`} opacity="0.8" />
                <path d="M75.127 27.581 53.581 40.576l21.546 39.125 21.506-13.018z" fill={`url(#${idPrefix}grad-f)`} opacity="0.8" />
            </g>
